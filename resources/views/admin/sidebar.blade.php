<nav class="sidebar sidebar-offcanvas" style="" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          ...
          <a href="{{url('/')}}" class="sidebar-brand brand-logo" style="color:white;"><span style="color:#00d9a5">My</span> Hospital</a>
          <a href="{{url('/')}}" class="sidebar-brand brand-logo-mini" style="color:white;"><span style="color:#00d9a5">M</span>S</a>
        </div>
        <ul class="nav">
