      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item" style="background-color:grey; color:black; border-radius:5px; ">
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/bg_image_1.jpg);">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        ...
        <a href="{{'appointdr'}}" class="btn btn-primary">Create Appointment</a>
      </div>
    </div>
  </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 wow fadeInUp ">
            <h1 class="display-4">Welcome to <br><span class="text-primary">My</span> Hospital</h1><br>
            <p class="text-grey mb-4">My Hospital is regarded as the most credible Healthcare Centre in the country, committed to Quality Health Care in the Nation’s service with personalized and compassionate patient care. It is also acclaimed for pioneering the private healthcare revolution in the country. Henceforth, My Hospital is hailed as one of the top best hospitals in Kathmandu, Nepal.</p>
